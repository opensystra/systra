...
<qgis version="2.18.12" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="level_0">
    ...
    <edittype widgetv2type="TextEdit" name="included">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="keep">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="load">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="offset_dd_expression" v="0.5*(width)"/>
          <prop k="offset_dd_field" v="width"/>
  ...
  <displayfield>Unnamed:_0</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    <alias field="level_0" index="0" name=""/>
    <alias field="index" index="1" name=""/>
    <alias field="a" index="2" name=""/>
    <alias field="b" index="3" name=""/>
    <alias field="fclass" index="4" name=""/>
    <alias field="included" index="5" name=""/>
    <alias field="keep" index="6" name=""/>
    <alias field="length" index="7" name=""/>
    <alias field="volume" index="8" name=""/>
    <alias field="load" index="9" name=""/>
    <alias field="color" index="10" name=""/>
    <alias field="width" index="11" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column width="-1" hidden="0" type="field" name="level_0"/>
      ...
      <column width="-1" hidden="0" type="field" name="included"/>
      <column width="-1" hidden="0" type="field" name="keep"/>
      <column width="-1" hidden="0" type="field" name="length"/>
      <column width="-1" hidden="0" type="field" name="volume"/>
      <column width="-1" hidden="0" type="field" name="load"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default field="level_0" expression=""/>
    <default field="index" expression=""/>
    <default field="a" expression=""/>
    <default field="b" expression=""/>
    <default field="fclass" expression=""/>
    <default field="included" expression=""/>
    <default field="keep" expression=""/>
    <default field="length" expression=""/>
    <default field="volume" expression=""/>
    <default field="load" expression=""/>
